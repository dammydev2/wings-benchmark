    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-sm-12">
            <table class="table" id="tblData">
                <tr>
                    <th colspan="13">
                        <img src="{{ asset('images/wings-logo-80x80.png') }}" style="width: 50px; margin-left: 100px;">
                        <h3 style="margin-top: -40px; margin-left:150px;">WINGS BY NINESEAS LOGISTICS</h3>
                        <span>
                            <center> Suite 17, Block B, Alausa Shopping Complex, 131 Obafemi Awolowo, Ikeja, Lagos State. </center>
                        </span>
                        <span>
                            <center><i class="fa fa-phone"></i> 0908-6532-777 , 08097765985 <i class="fa fa-envelope"></i> info@wingsng.com </center>
                        </span>
                    </th>
                </tr>
                <tr>
                    <th colspan="13">
                        <center>{{ Session::get('customer') }} delivery data from {{ Session::get('from') }} to {{ Session::get('to') }}</center>
                    </th>
                </tr>
                <tr>
                    <th>Date</th>
                ...
                @endforeach
                <tr>
                    <th colspan="11" class="text-right">Cost of Delivery</th>
                    <th> {{ number_format($sum, 2) }} </th>
                </tr>
                <tr style="color: green;">
                    <th colspan="11" class="text-right">Paid for</th>
                    <th>
                        <?php $sum2 = 0; ?>
        ...
        <form class="col-sm-12 col-lg-8" method="post" action="{{ url('/sendmail') }}">
            @csrf
